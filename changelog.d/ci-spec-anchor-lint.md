...
advisory. The gate is diff-scoped rather than repo-wide because 19 of the 51
specs on `main` currently gate, and those are overwhelmingly shorthand-path
false positives rather than real phantoms — a repo-wide gate would fail on day
