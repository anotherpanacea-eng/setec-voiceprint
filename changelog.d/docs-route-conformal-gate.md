...
- Refuse non-finite calibration observations at both file ingestion and programmatic conformal entry points so `NaN`/infinities cannot license a threshold or FPR-bound claim.
