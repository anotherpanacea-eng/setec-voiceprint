...
- **Embedding-explanation** — `cosine_explanation` on the `embedding_explanation` surface (PR #231; arXiv:2510.05362 / 2409.07072). Named side-by-side for the LUAR cosine; the opaque embedding distance becomes human-checkable.
