...
| [`74-passage-remediation-package.md`](74-passage-remediation-package.md) | **Draft; build-blocked pending another independent spec review.** Strict-byte, raw-confirmed Stage-B loss masks; proposed pairing exclusion; confined committed-directory publication; deterministic map/attestation production; and a versioned `author_corpus_export` carrier preserving `passage_dedup`. |
