...
| [`76-register-classifier-refusal-reasons.md`](76-register-classifier-refusal-reasons.md) | **Spec BUILD-READY at SHA-256 `5be5f74d…`; implementation re-review pending.** H1-only additive structured refusal taxonomy for `classify_register`, so the H2 register-composition sweep can consume short/all-weak/tie outcomes without parsing warnings or reimplementing classifier rules. |
