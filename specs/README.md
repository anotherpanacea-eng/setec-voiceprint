...
| [`82-verbatim-mosaic-audit.md`](82-verbatim-mosaic-audit.md) | **Draft.** Descriptive verbatim-mosaic profile on `set_level_diversity` (per-span source multiplicity and junction style distance against a named pool, extending the DJ-Search `originality_audit`), plus a local replay of shipped signals on public-domain Frankentext-style mosaics (arXiv 2505.18128). No verdict; stdlib M1. |
