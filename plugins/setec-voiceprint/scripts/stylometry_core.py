...
import stylometry_distance as _distance

# Compatibility exports: callers keep the established stylometry_core API,
# while normalized-feature consumers can import the pure module directly.
compute_clusters = _distance.compute_clusters
cosine_distance = _distance.cosine_distance
family_distance = _distance.family_distance
feature_vector = _distance.feature_vector
safe_mean = _distance.safe_mean
safe_sd = _distance.safe_sd
